...
export const getProfitUserMonthListApi = (params: any) => request.get('/profits/user-months', { params })
export const getProfitCardMonthListApi = (params: any) => request.get('/profits/card-months', { params })
