...
| 服务 | 访问地址 | 状态 |
|------|----------|------|
| **前端应用** | [https://dev-4g1sv3870175b971-1411764939.tcloudbaseapp.com/?v=202605061950](https://dev-4g1sv3870175b971-1411764939.tcloudbaseapp.com/?v=202605061950) | ✅ 已上线 |
...
- **当前线上版本**: bank-admin-backend-029 (部署中...)
- **服务类型**: 容器型 (Container)
- **CPU**: 1 核
- **内存**: 2 GB
- **最小实例数**: 1
